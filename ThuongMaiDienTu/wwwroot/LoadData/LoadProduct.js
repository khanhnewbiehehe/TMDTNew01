                    ...
                    <div class="card my_card">
                        ...
                        <div class="my_cardimage d-flex justify-content-center align-items-center">
                            <div class="my_overlay d-flex justify-content-center align-items-center">
                                <a onClick="CreateFavourite(${
                                  item.id
                                })" class="btn my_overlaybtn d-flex justify-content-center align-items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            ...
                            <h5 class="card-title my_card_title">${
                              item.name
                            }</h5>
                            <p class="my_pricestyle mt-2">${item.min.toLocaleString(
                              "vi-VN"
                            )}₫ - ${item.max.toLocaleString("vi-VN")}₫</p>
                            <div class="progress my_progress">
                                <div class="progress-bar progress-bar-striped" title="${
                                  item.registration
                                }" role="progressbar"
                                     style="width: ${
                                       (item.registration * 100) / item.quantity
                                     }%"
                                     aria-valuenow="${
                                       (item.registration * 100) / item.quantity
    ...
    success: function (data) {
      if (data.redirect) {
        Swal.fire({
          ...
          text:
            data.message || "Vui lòng đăng nhập trước khi thêm vào yêu thích.",
          icon: "warning",
